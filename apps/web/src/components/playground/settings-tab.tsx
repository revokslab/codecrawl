    ...
    <Box className={cn('py-6 rounded-lg')}>
      <Flex direction={'column'} gap='8'>
        <Flex direction='column' gap='6' className='flex-1'>
          ...
          <label>
            <Text size='2' weight='medium' as='div' mb='1' className='text-[var(--gray-11)]'>
        ...
        <Flex direction='column' gap='4' className='md:basis-1/3'>
          ...
          <Text as='label' size='2' className='flex items-center gap-2 cursor-pointer'>
            <Checkbox
              id='include-summary'
              checked={fileSummary}
              onCheckedChange={(checked) => handleCheckboxChange('fileSummary', Boolean(checked))}
              color='orange'
            />{' '}
          ...
          <Text as='label' size='2' className='flex items-center gap-2 cursor-pointer'>
            <Checkbox
              ...
              onCheckedChange={(checked) => handleCheckboxChange('parsableStyle', Boolean(checked))}
              color='orange'
            />{' '}
        ...
        <Flex direction='column' gap='4' className='md:basis-1/3'>
          ...
          <Text as='label' size='2' className='flex items-center gap-2 cursor-pointer'>
            <Checkbox
              id='compress-code'
              checked={compress}
              onCheckedChange={(checked) => handleCheckboxChange('compress', Boolean(checked))}
              color='orange'
            />{' '}
            Compress Code
          </Text>
