import Codecrawl, { type CrawlOptions, type GenerateLLMsTextParams } from '@codecrawl/sdk'
...
export const CodecrawlService = {
  ...
  useMarketingInstance: (): {
    generateLLMsTxt: (url: string, options?: GenerateLLMsTextParams) => Promise<any>
    ...
    const generateLLMsTxt = async (url: string, options?: GenerateLLMsTextParams) => {
